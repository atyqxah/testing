...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Fast Post Tracking</title>
    ...
    <body class="antialiased">
        <nav class="navbar navbar-light bg-light" style="background-color: #f30606; padding: 0 15px; height: 80px; line-height: 80px;">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-40 sm:block">
                    @auth
                    ...
                    @else
                        ...
                        text-align: center;
                        text-decoration: none;
                        display: inline;  background-color: rgb(5, 5, 5); border-radius: 10px; ">Log in</a>
                        ...
                        @if (Route::has('register'))
                            ...
                            text-align: center;
                            text-decoration: none;
                            display: inline;  background-color: rgb(5, 5, 5); border-radius: 10px;" >Register</a>
                        @endif
                    @endauth
                </div>
            @endif
        ...
        <center><a style= "color:#fff; font-size: 2cm;">FAST POST TRACKING</a></center>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-2 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-1">
                     <div class="p-6">
                        <center><img src="{{ asset('img/fragile.jpg') }}" height="400px" /></center>


                        <div class="ml-12" style="text-align: center" >
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Malaysia tracking parcel
                            </div>
                        </div>
                    </div>
                </div>
